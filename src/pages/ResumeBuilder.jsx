          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            {isInAppBrowser() ? (
              <div style={{ background: 'rgba(239, 68, 68, 0.1)', color: '#FCA5A5', padding: '16px', borderRadius: '8px', marginBottom: '16px', fontSize: '14px', border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                ...
                <p style={{ margin: 0, lineHeight: 1.5 }}>To continue, tap the <strong>•••</strong> menu icon (at the top or bottom of your screen) and select <strong>"Open in browser"</strong> (like Chrome or Safari).</p>
              </div>
            ) : (
